...
Репозиторий разделен на три основных раздела:
...
- **Финальный проект (Final Project)**: Комплексное сравнение производительности алгоритмов сортировки на CPU и GPU.
...
| **Practice 8** | **Гибридные вычисления** | Основы совместного использования CPU и GPU. Оптимизация передачи данных, pinned memory. |
| **Practice 9** | **MPI** | Распределенные вычисления. Блокирующие/неблокирующие обмены, коллективные операции. |
| **Practice 10** | **Анализ производительности** | Профилирование, законы Амдала и Густафсона, Strong vs Weak scaling. |

### 🏆 Финальный Проект (Final Project)

| Проект | Описание | Технологии |
| ------ | -------- | ---------- |
| **Parallel Sorting** | Сравнение производительности сортировки слиянием (OpenMP) и битонической сортировки (CUDA). Визуализация результатов на Python. | C++, OpenMP, CUDA, Python |
...
6. **Python 3**: Требуется для визуализации результатов в **Final Project** (библиотеки `pandas`, `matplotlib`).
...
Перейдите в директорию `final_project` и запустите скрипт сборки:
